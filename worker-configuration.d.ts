/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1f6e91e6fe631630250e2ef3c94c819a)
// Runtime types generated with workerd@1.20251125.0 2025-03-10 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ReflectMCP";
	}
	interface Env {
		OAUTH_KV: KVNamespace;
		REFLECT_CLIENT_ID: string;
		REFLECT_CLIENT_SECRET: string;
		COOKIE_ENCRYPTION_KEY: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").ReflectMCP>;
	}
}
